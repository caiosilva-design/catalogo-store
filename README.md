...
1. Recebe a URL da imagem.
2. Faz uma requisição para a origem.
3. Obtém o conteúdo da imagem.
4. Retorna a imagem para o navegador.
5. Define cache de até 1 ano.
...
3. A Vercel identificará automaticamente o projeto Next.js.
4. Execute o deploy.
